...
import RoomVoters from './RoomVoters'
import { createVoteRoom } from "../../_actions_/voter/actions/voterAction"
...
const CreateVoteRoom = ({createVoteRoom}) => {
      ...
      <CardContent>
        <FormikStepper
          ...
          onSubmit={async (values , {setSubmitting}) => {
            ...
            createVoteRoom(values,navigate,setSubmitting)
          }}
        >
          ...
          <br/>
          <br/>
          <RoomVoters sendVoters={sendVoters}/>
...
export default connect(null,{createVoteRoom}) (CreateVoteRoom)